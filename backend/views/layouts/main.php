        ...
        <div class="sidebar-menu">
            <?php
                if (!Yii::$app->user->isGuest) {
                    $menuItems = [
                        ['label' => Yii::t('main', 'Главная'), 'icon' => 'pg-home', 'url' => '/site/index']
                    ];

                    $menuItems[] = ['label' => Yii::t('main', 'Новости'), 'icon' => 'pg-layouts', 'items' => [
                        ['label' => Yii::t('main', 'Все новости'), 'url' => '/news/index', 'icon' => 'NS'],
//                        ['label' => Yii::t('main', 'Категории новостей'), 'url' => '/news-category/index', 'icon' => 'NC'],
                    ]];


                    $menuItems[] = ['label' => Yii::t('main', 'Товары'), 'icon' => 'pg-layouts', 'items' => [
                        ['label' => Yii::t('main', 'Все Товары'), 'url' => '/product/index', 'icon' => 'P'],
                        ['label' => Yii::t('main', 'Категории товаров'), 'url' => '/product-category/index', 'icon' => 'PC'],
                       ['label' => Yii::t('main', 'Бренд товаров'), 'url' => '/brand/index', 'icon' => 'C'],
                       ['label' => Yii::t('main', 'Цает товаров'), 'url' => '/color/index', 'icon' => 'C']
                    ]];


                    $menuItems[] = ['label' => Yii::t('main', 'Меню'), 'icon' => 'pg-layouts', 'items' => [
                        ['label' => Yii::t('main', 'Меню'), 'url' => '/menu/index', 'icon' => 'ME'],
                    ]];

                    $menuItems[] = ['label' => Yii::t('main', 'Баннеры'), 'url' => '/banner/index', 'icon' => 'fas fa-tv'];


                    $menuItems[] = ['label' => Yii::t('main', 'Социальные сети'), 'icon' => 'fa fa-globe', 'items' => [
                        ['label' => Yii::t('main', 'Список Соц.сети'), 'url' => '/social/index', 'icon' => 'СЦ'],

                    ]];

                    $menuItems[] = ['label' => Yii::t('main', 'Настройки'), 'icon' => 'pg-settings', 'items' => [
                        ['label' => Yii::t('main', 'Пользователи'), 'url' => '/user/index', 'icon' => 'П'],
                        ['label' => 'Главные настройки', 'url' => '/settings/index', 'icon' => 'ОС'],
        ...
        <div class="header">
            <div class="container-fluid relative">
                ...
                <div class="pull-center hidden-md hidden-lg">
                    <div class="header-inner">
                        <div class="brand inline">АДМИН</div>
                    </div>
                </div>
            </div>
