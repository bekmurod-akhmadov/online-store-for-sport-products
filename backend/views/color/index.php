        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                        ...
                        <?= Html::a( Yii::t('main','Create Color'), ['create'], ['class' => 'btn btn-success']) ?>
...
[
                                                ...
                                                'content'=>function($model){
                                                    $color = $model->name;
                                                    $result =  "<div style='height: 30px;width:20%;color: white;text-align: center;padding: 5px;background: $color'>$color</div>";
                                                   return $result;
                                                },
