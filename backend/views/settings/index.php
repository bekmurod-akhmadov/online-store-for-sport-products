...
$this->title = Yii::t('main', 'Настройки');
        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Добавить'), ['/settings/create'], ['class' => 'btn btn-success']) ?>
                                        ...
                                        'buttons' => function ($url, $model) {
                                            ...
                                            $code = <<<BUTTONS
	                                                <div class="btn-group flex-center">
	                                                    <a href="/{$controller}/update?id={$model->id}" class="btn btn-complete"><i class="fa fa-pencil"></i></a>
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <? \yii\widgets\ActiveForm::begin(['action' => '/settings/index']);?>
